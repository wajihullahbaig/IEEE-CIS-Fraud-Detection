...
label_file = 'single_model_lgbm_submission_holdout_pred_s0_d_ds.csv'
training_files = [
                  'single_model_lgbm_submission_holdout_proba_s0_d_ds.csv',
                  'single_model_lgbm_submission_holdout_proba_s0_m_ms.csv',
                  'single_model_lgbm_submission_holdout_proba_s0_h_hs.csv',
                  'single_model_lgbm_submission_holdout_proba_s0_dow_dows.csv',
